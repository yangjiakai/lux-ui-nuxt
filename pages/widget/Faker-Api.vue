          ...
          <v-card-text>
            <div v-for="(item, key) in animal" :key="key">
              <div class="d-flex">
                ...
                <span class="flex-fill">{{ item.value }}</span><b class="text-blue">{{ item.code }}</b>
              </div>
        ...
        <v-card>
          ...
          <v-card-text>
            <div v-for="(item, key) in commerce" :key="key">
              <div class="d-flex">
                <b class="mr-1">{{ item.label }}:</b>
                <span class="flex-fill">{{ item.value }}</span><b class="text-blue">{{ `faker.commerce.${key}()` }}</b>
              </div>
              <v-divider class="my-2"></v-divider>
            </div>
          </v-card-text>
        ...
        <v-card>
          ...
          <v-card-text>
            <div v-for="(item, key) in color" :key="key">
              <div class="d-flex">
                <b class="mr-1">{{ item.label }} : </b>
                <span class="flex-fill">{{ item.value }}</span><b class="text-blue">{{ `faker.color.${key}()` }}</b>
              </div>
              <v-divider class="my-2"></v-divider>
            </div>
          </v-card-text>
        ...
        <v-card>
          ...
          <v-card-text>
            <div v-for="(item, key) in company" :key="key">
              <div class="d-flex">
                <b class="mr-1">{{ item.label }} : </b>
                <span class="flex-fill">{{ item.value }}</span><b class="text-blue">{{ `faker.company.${key}()` }}</b>
              </div>
              <v-divider class="my-2"></v-divider>
            </div>
          </v-card-text>
        ...
        <v-card>
          ...
          <v-card-text>
            <div v-for="(item, key) in database" :key="key">
              <div class="d-flex">
                <b class="mr-1">{{ item.label }} : </b>
                <span class="flex-fill">{{ item.value }}</span><b class="text-blue">{{ `faker.database.${key}()` }}</b>
              </div>
              <v-divider class="my-2"></v-divider>
            </div>
          </v-card-text>
        ...
        <v-card>
          ...
          <v-card-text>
            <div v-for="(item, key) in date" :key="key">
              <div class="d-flex">
                <b class="mr-1">{{ item.label }} : </b>
                <span class="flex-fill">{{ item.value }}</span><b class="text-blue">{{ `faker.date.${key}()` }}</b>
              </div>
              <v-divider class="my-2"></v-divider>
            </div>
          </v-card-text>
        ...
        <v-card>
          ...
          <v-card-text>
            <div v-for="(item, key) in finance" :key="key">
              <div class="d-flex">
                <b class="mr-1">{{ item.label }} : </b>
                <span class="flex-fill">{{ item.value }}</span><b class="text-blue">{{ `faker.finance.${key}()` }}</b>
              </div>
              <v-divider class="my-2"></v-divider>
            </div>
          </v-card-text>
        ...
        <v-card>
          ...
          <v-card-text>
            <div v-for="(item, key) in hacker" :key="key">
              <div class="d-flex">
                <b class="mr-1">{{ item.label }} : </b>
                <span class="flex-fill">{{ item.value }}</span><b class="text-blue">{{ `faker.hacker.${key}()` }}</b>
              </div>
              <v-divider class="my-2"></v-divider>
            </div>
          </v-card-text>
        ...
        <v-card>
          ...
          <v-card-text>
            <div v-for="(item, key) in internet" :key="key">
              <div class="d-flex">
                <b class="mr-1">{{ item.label }} : </b>
                <span class="flex-fill"> {{ item.value }} </span><b class="text-blue">{{ `faker.internet.${key}()` }}</b>
              </div>
              <v-divider class="my-2"></v-divider>
            </div>
          </v-card-text>
        ...
        <v-card>
          ...
          <v-card-text>
            <div v-for="(item, key) in lorem" :key="key">
              <div class="d-flex">
                <b class="mr-1">{{ item.label }} : </b>
                <span class="flex-fill"> {{ item.value }} </span><b class="text-blue">{{ `faker.lorem.${key}()` }}</b>
              </div>
              <v-divider class="my-2"></v-divider>
            </div>
          </v-card-text>
        ...
        <v-card>
          ...
          <v-card-text>
            <div v-for="(item, key) in phone" :key="key">
              <div class="d-flex">
                <b class="mr-1">{{ item.label }} : </b>
                <span class="flex-fill"> {{ item.value }} </span><b class="text-blue">{{ `faker.phone.${key}()` }}</b>
              </div>
              <v-divider class="my-2"></v-divider>
            </div>
          </v-card-text>
        ...
        <v-card>
          ...
          <v-card-text>
            <div v-for="(item, key) in git" :key="key">
              <div class="d-flex">
                <b class="mr-1">{{ item.label }} : </b>
                <span class="flex-fill"> {{ item.value }} </span><b class="text-blue">{{ `faker.git.${key}()` }}</b>
              </div>
              <v-divider class="my-2"></v-divider>
            </div>
          </v-card-text>
        ...
        <v-card>
          ...
          <v-card-text>
            <div v-for="(item, key) in system" :key="key">
              <div class="d-flex">
                <b class="mr-1">{{ item.label }} : </b>
                <span class="flex-fill"> {{ item.value }} </span><b class="text-blue">{{ `faker.system.${key}()` }}</b>
              </div>
              <v-divider class="my-2"></v-divider>
            </div>
          </v-card-text>
